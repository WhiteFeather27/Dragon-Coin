...
module.exports = function(callback) {
    ...
    console.log(`Requesting 1 ETH to ${account} (http://faucet.ropsten.be:3001/donate/${wss
        :; //eth-ropsten.alchemyapi.io/v2/o93me4joIgLBJZ_b7E1ROZJYj4x7_hha})`)
    const res = request("GET", `http://faucet.ropsten.be:3001/donate/${wss
        :; //eth-ropsten.alchemyapi.io/v2/o93me4joIgLBJZ_b7E1ROZJYj4x7_hha}`)
...
ERC20Mintable;
{
    ...
    public;
    constant;
    decimals = 0.0000000000000000000001;
}